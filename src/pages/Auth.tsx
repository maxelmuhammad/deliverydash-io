      ...
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <h1 className="text-2xl font-bold">doublequick</h1>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {isLogin ? 'Enter your credentials to access your dashboard' : 'Enter your details to create your account'}
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 text-center">
              <button type="button" onClick={() => setIsLogin(!isLogin)} className="text-sm text-primary hover:text-primary-hover underline">
